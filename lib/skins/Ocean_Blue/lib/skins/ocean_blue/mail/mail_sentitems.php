...
<?php
    ...
    ?>
            <tr>
                ...
                <td align="center"><a href="<?php echo SITE_URL ?>/index.php/Mail/sent_delete/?mailid=<?php echo $test->id;?>"><img src="<?php echo SITE_URL?>/core/modules/Mail/mailimages\delete.png" alt="Delete" border="0"/></a></td>
